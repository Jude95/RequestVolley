...
public class NetworkImageView extends ImageView {
	...
	/**
	 * Sets the default image resource Drawable to be used for this view until
	 * the attempt to load it completes.
	 */
	public void setDefaultImageDrawable(Drawable imageDrawable) {
		mErrorImageDrawable = imageDrawable;
	}
